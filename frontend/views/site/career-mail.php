...
<html>
    ...
    <head>
        <title>Career Application Received From Website</title>
    </head>
        ...
        <div class="mail-body" style="margin: auto;width: 70%;border: 1px solid #9e9e9e;">
            <div class="content" style="margin: 40px;">
                ...
                <table style="border-collapse: collapse;width: 100%;text-align: left;margin-bottom: 30px;border: 1px solid black;">
                    ...
                    <tr>
                        <th style="border: 1px solid black;text-align: left;padding: 5px 10px;">Position</th>
                        <td style="border: 1px solid black;text-align: left;padding: 5px 10px;"><?= $model->position ?></td>
                    </tr>
                    <tr>    
                        <th style="border: 1px solid black;text-align: left;padding: 5px 10px;">Portfolio Url</th>
                        <td style="border: 1px solid black;text-align: left;padding: 5px 10px;"><?= $model->portfolio_url ?></td>
                    </tr>
                    <tr>
