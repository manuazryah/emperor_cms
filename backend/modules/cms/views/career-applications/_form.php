...
<div class="career-applications-form form-inline">
...
</div><div class='col-md-4 col-sm-6 col-xs-12 left_padd'>    <?= $form->field($model, 'portfolio_url')->textInput(['maxlength' => true]) ?>
