...
<div class="sectors-form form-inline">
    ...
    <div class="row">
        ...
        <div class='col-md-4 col-sm-6 col-xs-12 left_padd'>    
            <?= $form->field($model, 'main_image', ['options' => ['class' => 'form-group'], 'template' => '{label}<label>Main Image [ File Size :( 1920*900 ) ]</label>{input}{error}'])->fileInput(['maxlength' => true])->label(FALSE) ?>
            <?php
            if ($model->isNewRecord)
                echo "";
            else {
